  ...
  ISmartProvider
{
  ...
  event RedeemLpCollateral(address indexed liquidator, uint256 lpAmount, uint256 minAmount0, uint256 minAmount1);
  ...
  function redeemLpCollateral(
    ...
    emit RedeemLpCollateral(liquidator, lpAmount, minAmount0, minAmount1);
  }
